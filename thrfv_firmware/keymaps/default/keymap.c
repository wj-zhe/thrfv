...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
            ...
            KC_LEFT, KC_RIGHT, LT(2,KC_TAB), LALT_T(KC_BSPC), KC_MUTE,
            LGUI_T(KC_ENT), LALT_T(KC_SPC), MO(1), KC_DOWN, KC_UP
    ...
    [1] = LAYOUT(
            ...
            KC_LSFT, KC_NO, KC_NO, KC_EQL, KC_PLUS,
